			...
			const struct i2c_device_id *id)
{
	...
	do {
		...
		pr_info("%s \n", __func__);
		pr_info("fuelgauge_info:0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x \n", 
				fuelgauge_info[0],fuelgauge_info[1],fuelgauge_info[2],
				fuelgauge_info[3],fuelgauge_info[4],fuelgauge_info[5],
				fuelgauge_info[6],fuelgauge_info[7]);

		pr_info("fuelgauge_addr:0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x \n", 
				bq27541CMD_ADF, bq27541CMD_ADF+1, bq27541CMD_ADF+2,
				bq27541CMD_ADF+3, bq27541CMD_ADF+4, bq27541CMD_ADF+5,
				bq27541CMD_ADF+6, bq27541CMD_ADF+7);
